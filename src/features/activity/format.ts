...
const EMAIL_TEMPLATE_LABELS: Record<string, string> = {
  ...
  webseo_gsc_followup: 'Web SEO – GSC access follow-up',
  localseo_gbp_followup: 'Local SEO – GBP access follow-up',
  webdev_client_form: 'Web Dev – client intake form',
  webdev_form_followup: 'Web Dev – intake form follow-up',
  webdev_waiting_nudge: 'Web Dev – waiting-on-client nudge',
