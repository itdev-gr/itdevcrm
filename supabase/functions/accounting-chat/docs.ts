// GENERATED from docs/boards/accounting.md — regenerate when that doc
// changes (scripts: see the accounting-chat deploy notes). Do not hand-edit.
export const ACCOUNTING_BOARD_DOC = `# Accounting
