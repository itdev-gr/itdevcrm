...
-- when the creator is the one doing the update (created_by = auth.uid() — covers
-- a creator resolving a delegated task directly, since user_tasks has no
-- completed_by column), or when created_by is null (legacy rows).
-- =============================================================================
