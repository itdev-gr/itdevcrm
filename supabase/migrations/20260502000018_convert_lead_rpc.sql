...
begin
  ...
  -- 1. Create client row (note: lead.notes is propagated to deal.description below;
  -- clients table has no `notes` column in MVP)
  insert into public.clients (
    name, contact_first_name, contact_last_name, email, phone, address,
    industry, country, vat_number, assigned_owner_id
  ) values (
    l.company_name, l.contact_first_name, l.contact_last_name, l.email, l.phone, l.address,
    l.industry, l.country, l.vat_number, l.owner_user_id
