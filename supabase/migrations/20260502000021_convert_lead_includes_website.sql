-- =============================================================================
-- Update convert_lead_to_client to copy lead.website into the new client row
-- (clients.website was previously left null on conversion).
-- =============================================================================
...
begin
  ...
  -- 1. Create client row (now includes website)
