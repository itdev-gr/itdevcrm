-- =============================================================================
-- Allow `recurring_yearly` as a billing_type on jobs (used for hosting).
-- complete_accounting RPC also extended so spawned jobs can carry the new type.
-- The leads / deals tables don't have a CHECK on billing_type — the value is
-- stored inside the services_planned JSONB and validated server-side only at
-- conversion time.
-- =============================================================================
