-- Track how the customer pays the deal (cash vs online).
-- Captured on the lead, carried over to the deal at conversion, editable on
-- both the lead form (sales) and the deal form (accounting).
...
-- Patch convert_lead_to_client so the deal inherits the chosen method.
